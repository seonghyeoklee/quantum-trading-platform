...
// import TwoFactorSetup from '@/components/auth/TwoFactorSetup'; // MVP에서는 미구현
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container max-w-6xl mx-auto py-8 px-4">
        ...
        <div className="grid gap-8">
          {/* 2FA 설정 모달 - MVP에서는 미구현 */}
          {showTwoFactorSetup && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
              <div className="w-full max-w-md mx-4 p-6 bg-background rounded-lg">
                <h3 className="text-lg font-semibold mb-4">2단계 인증 설정</h3>
                <p className="text-muted-foreground mb-4">
                  MVP 1.0에서는 2단계 인증 기능이 준비 중입니다.
                </p>
