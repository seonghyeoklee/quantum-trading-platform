...
/**
 * 키움증권 주식틱차트조회요청 (ka10079) DTO
 * POST /api/dostk/chart
 */
@Data
@EqualsAndHashCode(callSuper = true)
@SuperBuilder
@Schema(description = "주식틱차트조회요청 (ka10079)")
public class TickChartRequest extends BaseChartRequest {
     ...
     */
    public static TickChartRequest of(String stockCode, String baseDate) {
        return TickChartRequest.builder()
                .stockCode(stockCode)
                .baseDate(baseDate)
                .updStkpcTp("1")
                .build();
     ...
     */
    public static TickChartRequest of(String stockCode, LocalDate baseDate) {
     ...
     * 오늘 기준으로 생성
     */
    public static TickChartRequest ofToday(String stockCode) {
