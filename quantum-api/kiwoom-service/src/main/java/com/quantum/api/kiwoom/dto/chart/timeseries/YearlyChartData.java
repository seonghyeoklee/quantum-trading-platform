...
/**
 * 년봉 차트 개별 데이터
 * 키움 API stk_yr_pole_chart_qry 배열의 각 요소
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "년봉 차트 개별 데이터")
public class YearlyChartData {
    ...
    /**
     * 일자 (YYYYMMDD) - 년의 마지막 거래일
     */
    @JsonProperty("dt")
    @Schema(description = "일자(년의 마지막 거래일)", example = "20241231")
    private String date;
    ...
    @Schema(description = "전년종가", example = "132800")
