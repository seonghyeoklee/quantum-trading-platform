...
/**
 * 주봉 차트 개별 데이터
 * 키움 API stk_wk_pole_chart_qry 배열의 각 요소
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "주봉 차트 개별 데이터")
public class WeeklyChartData {
    ...
    /**
     * 일자 (YYYYMMDD) - 주의 마지막 거래일
     */
    @JsonProperty("dt")
    @Schema(description = "일자(주의 마지막 거래일)", example = "20241107")
    private String date;
    ...
    @Schema(description = "전주종가", example = "132800")
