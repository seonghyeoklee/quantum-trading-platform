 ...
 */
@Builder
public record UserRoleGrantedEvent(UserId userId, String username, String roleName, UserId grantedBy,
                                   String grantedByUsername, String reason, Instant grantedAt) {
